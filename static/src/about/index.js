            ...
            <div className={"about grid_container"}>
                <div className={"grid_content"}>
                    ...
                    <div className={"about_text_container"}>
                        <p className={"about_text"}>I am a recent graduate, and Software Developer with a passion for what I do. My interest in software development began at a young age when I would write mods for video games to add my own personal touch, and has continued to grow ever since. I've recently graduated from the University of Toronto Specialist Program in Computer Science. where I was fortunate enough to further pursue this passion.</p>
